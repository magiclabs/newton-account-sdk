 ...
 * @property attesters - Optional array of {@link Address} attester addresses (defaults to [NEWTON_ATTESTER_ADDRESS])
...
>(
  ...
  const {
    ...
    signerAddress,
    index = 0n,
    attesters = [publicClient.chain?.testnet ? NEWTON_TESTNET_ATTESTER_ADDRESS : NEWTON_ATTESTER_ADDRESS],
    threshold = 1,
